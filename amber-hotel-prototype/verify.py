#!/usr/bin/env python3
"""Verify Amber prototype: images, booking widget, layout at multiple viewports."""
...
def main():
    with sync_playwright() as p:
        ...
        page.screenshot(path=str(ARTIFACTS / "amber-desktop-full.png"), full_page=True)

        page.set_viewport_size({"width": 390, "height": 844})
        page.wait_for_timeout(500)
        page.locator("#menuToggle").click()
        page.wait_for_timeout(400)
        page.screenshot(path=str(ARTIFACTS / "amber-mobile-menu.png"))
        ...
        page.locator("#guestTrigger").click()
        page.wait_for_timeout(300)
        page.screenshot(path=str(ARTIFACTS / "amber-mobile-booking.png"))

        page.evaluate("window.scrollTo(0, document.body.scrollHeight)")
        page.wait_for_timeout(600)
        page.screenshot(path=str(ARTIFACTS / "amber-mobile-full.png"), full_page=True)
