#!/usr/bin/env python3
"""Record a walkthrough video of the Burtakas hotel prototype."""
...
VIDEO_DIR = ARTIFACTS / "burtakas-walkthrough-video"
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#roomType").select_option("terases")
        page.wait_for_timeout(600)
        ...
        if video_path:
            dest = ARTIFACTS / "burtakas-hotel-prototype-walkthrough.webm"
