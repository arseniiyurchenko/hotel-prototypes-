#!/usr/bin/env python3
"""Record a walkthrough video of the Cavendish Banqueting prototype."""
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#functionType").select_option(label="Mehendi/Sangeet")
        page.wait_for_timeout(400)
        ...
        for section in ["#hall", "#features", "#gallery", "#location", "#contact"]:
