#!/usr/bin/env python3
"""Record a walkthrough video of the CityHovi prototype."""
...
VIDEO_DIR = ARTIFACTS / "cityhovi-walkthrough-video"
...
def main():
    with sync_playwright() as p:
        ...
        for section in ["#story", "#rooms", "#amenities", "#gallery", "#location", "#trust"]:
        ...
        if video_path:
            dest = ARTIFACTS / "cityhovi-prototype-walkthrough.webm"
