#!/usr/bin/env python3
"""Record walkthrough video of Forenom Rauma prototype."""
...
VIDEO_DIR = ARTIFACTS / "forenom-rauma-walkthrough-raw"
...
def main():
    with sync_playwright() as p:
        ...
        context = browser.new_context(
            ...
            extra_http_headers={"Referer": "https://www.forenom.com/"},
        )
        ...
        if video_path:
            dest = ARTIFACTS / "forenom-rauma-prototype-walkthrough.webm"
