#!/usr/bin/env python3
"""Record walkthrough video of Haus Anna prototype."""
...
VIDEO_DIR = ARTIFACTS / "hausanna-walkthrough-video"
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#roomType").select_option("twin")
        page.wait_for_timeout(600)
        page.mouse.click(400, 120)
        page.wait_for_timeout(400)
        ...
        if video_path:
            dest = ARTIFACTS / "hausanna-walkthrough.webm"
