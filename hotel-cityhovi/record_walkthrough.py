#!/usr/bin/env python3
"""Record a walkthrough video of the Hotel CityHovi prototype."""
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#roomType").select_option("canal")
        page.wait_for_timeout(600)
        ...
        if video_path:
            dest = ARTIFACTS / "hotel-cityhovi-prototype-walkthrough.webm"
