#!/usr/bin/env python3
"""Record a walkthrough video of the Frans & Frans hotel prototype."""
...
VIDEO_DIR = ARTIFACTS / "fransfrans-walkthrough-raw"
VIDEO_DIR.mkdir(parents=True, exist_ok=True)
OUT = ARTIFACTS / "fransfrans-walkthrough.webm"
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#roomType").select_option("sauna-studio")
        page.wait_for_timeout(600)
        ...
        if video_path:
            ...
            if OUT.exists():
                OUT.unlink()
            src.replace(OUT)
            print(f"Walkthrough saved to {OUT}")
        else:
