#!/usr/bin/env python3
"""Verify Hulme Hall prototype: images, enquiry form, layout at multiple viewports."""
...
def main():
    with sync_playwright() as p:
        ...
        page.locator("#enquiryMessage").fill("Looking at a Saturday reception for about 120 guests.")
        results["interactions"].append("enquiry form filled")
        ...
        page.screenshot(path=str(ARTIFACTS / "desktop-hero.png"), full_page=False)
        ...
        page.locator("#rooms").scroll_into_view_if_needed()
        page.wait_for_timeout(400)
        page.screenshot(path=str(ARTIFACTS / "mobile-rooms.png"))
