#!/usr/bin/env python3
"""Record a walkthrough video of the Krasta Māja guest-house prototype."""
...
VIDEO_DIR = ARTIFACTS / "krasta-maja-walkthrough-video"
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#stayType").select_option("week")
        page.wait_for_timeout(600)
        ...
        for section in ["#intro", "#spaces", "#atmosphere", "#gallery", "#location", "#trust"]:
        ...
        if video_path:
            dest = ARTIFACTS / "krasta-maja-prototype-walkthrough.webm"
