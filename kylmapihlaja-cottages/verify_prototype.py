#!/usr/bin/env python3
"""Verify Kylmäpihlaja cottages prototype."""
...
def main():
    ...
    with sync_playwright() as p:
        ...
        page.locator("#roomType").select_option("maisemamokki")
        ...
        page.screenshot(path=str(ARTIFACTS / "kylmapihlaja-cottages-desktop.png"), full_page=True)
        ...
        page.screenshot(path=str(ARTIFACTS / "kylmapihlaja-cottages-mobile.png"), full_page=True)
