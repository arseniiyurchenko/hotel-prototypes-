#!/usr/bin/env python3
"""Record walkthrough video of Loft Hotel Rauma prototype."""
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#roomType").select_option("sauna")
        page.wait_for_timeout(600)
        ...
        if video_path:
            dest = ARTIFACTS / "loft-hotel-rauma-prototype-walkthrough.webm"
