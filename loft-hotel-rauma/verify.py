#!/usr/bin/env python3
"""Verify Loft Hotel Rauma prototype: images, widget, layout."""
...
def main():
    ...
    with sync_playwright() as p:
        ...
        page.screenshot(path=str(ARTIFACTS / "loft-hotel-rauma-desktop.png"), full_page=True)
        ...
        page.screenshot(path=str(ARTIFACTS / "loft-hotel-rauma-mobile.png"), full_page=True)
