#!/usr/bin/env python3
"""Record walkthrough video of Poroholma prototype."""
...
VIDEO_DIR = ARTIFACTS / "poroholma-walkthrough-raw"
...
def main():
    with sync_playwright() as p:
        ...
        for section in ["#accommodation", "#amenities", "#gallery", "#location", "#trust"]:
        ...
        if video_path:
            dest = ARTIFACTS / "poroholma-holiday-centre-walkthrough.webm"
