#!/usr/bin/env python3
"""Record a walkthrough video of the Roze Park Rooms prototype."""
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#roomType").select_option("double1")
        page.wait_for_timeout(600)
        ...
        if video_path:
            dest = ARTIFACTS / "roze-park-hotel-prototype-walkthrough.webm"
