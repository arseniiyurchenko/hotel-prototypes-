...
def main():
    with sync_playwright() as p:
        ...
        page.screenshot(path=str(ARTIFACTS / "roze-desktop-full.png"), full_page=True)

        page.set_viewport_size({"width": 390, "height": 844})
        page.wait_for_timeout(500)
        page.locator("#menuToggle").click()
        page.wait_for_timeout(400)
        page.screenshot(path=str(ARTIFACTS / "roze-mobile-menu.png"))
        page.locator("#navClose").click()

        page.locator("#guestTrigger").scroll_into_view_if_needed()
        page.locator("#guestTrigger").click()
        page.wait_for_timeout(300)
        page.screenshot(path=str(ARTIFACTS / "roze-mobile-booking.png"))
        page.screenshot(path=str(ARTIFACTS / "roze-mobile-full.png"), full_page=True)
