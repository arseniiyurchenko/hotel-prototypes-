#!/usr/bin/env python3
"""Record a walkthrough video of the Saules kempings prototype."""
...
VIDEO_DIR = ARTIFACTS / "saules-walkthrough-video"
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#roomType").select_option("goba")
        page.wait_for_timeout(600)
        ...
        if video_path:
            dest = ARTIFACTS / "saules-kempings-prototype-walkthrough.webm"
