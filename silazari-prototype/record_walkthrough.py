#!/usr/bin/env python3
"""Record a walkthrough video of the Silazari prototype (pricing focus)."""
...
VIDEO_DIR = ARTIFACTS / "silazari-walkthrough-video"
...
def main():
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(400)
        page.locator("#roomType").select_option("liela")
        page.wait_for_timeout(600)
        page.mouse.click(400, 200)
        page.wait_for_timeout(400)

        for section in ["#rooms", "#pricing", "#jacuzzi", "#amenities", "#gallery", "#location", "#trust"]:
        ...
        if video_path:
            dest = ARTIFACTS / "silazari-prototype-walkthrough.webm"
