#!/usr/bin/env python3
"""Verify Silazari prototype: images, booking widget, layout at multiple viewports."""
...
def main():
    with sync_playwright() as p:
        ...
        # Hero CSS background is not an <img>; spot-check that key hotlinks respond
        ...
        results["interactions"].append("room type selected: liela")
